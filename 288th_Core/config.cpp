class CfgPatches
{
	class 288th_Core
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"OPTRE_Vehicles","OPTRE_UNSC_Units","OPTRE_Weapons","OPTRE_Weapons_Ammo","OPTRE_Weapons_Rockets","OPTRE_MJOLNIR","OPTRE_MJOLNIR_data_anims","OPTRE_Ins_Units","A3_Characters_F","A3_Characters_F_Common","A3_Characters_F_Heads","A3_Weapons_F","A3_Data_F","A3_Data_F_Mark","OPTRE_ACE_Compat","OPTRE_FC_ACE_Compat","ace_common","ace_interact_menu","ace_explosives","ace_medical","ace_medical_engine","ace_medical_treatment"};
	};
};
...
class CfgFunctions
{
	...
	class NoRating
	{
		class Main
		{
			...
			{
				preInit = 1;
				file = "\288th_Core\Functions\fn_init.sqf";
			};
		};
	};
};
...
class Extended_PreInit_EventHandlers
{
	...
	class 288th_Drop_Vics
	{
		init = "call compile preprocessFileLineNumbers '288th_Core\Functions\XEH_288_Drop_Vic.sqf'";
	};
};
